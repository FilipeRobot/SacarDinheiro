...
namespace SacarDinheiroTemp
{
    public partial class Form1 : Form
    {
        ...
        private readonly double[] notasDisponiveis = { 100, 50, 20, 10, 5, 2, 1, 0.50, 0.25, 0.10, 0.05, 0.01 }; // novas notas/moedas em ordem crescente
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (DinheiroTemp.VericarEntrada(txtEntrada.Text.Trim().Replace('.', ','), saldoTotal, Text))
            {
                int[] qtdNotasSacadas = DinheiroTemp.SacarValor(Convert.ToDouble(txtEntrada.Text.Trim().Replace('.', ',')), notasDisponiveis);
